...
function loadall_binhluan2($item_per_page, $offset)
{

    $sql = "SELECT*FROM binhluan  INNER JOIN user ON binhluan.iduser=user.iduser order by mabl desc limit $item_per_page offset $offset";
    $listbinhluan2 = pdo_query($sql);
    return $listbinhluan2;
}
