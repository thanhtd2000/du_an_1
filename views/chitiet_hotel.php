      ...
      <div class="view__content">
            ...
            <div class="view__main">
                  <div class="view__main__text">
                        <div class="row">
                              <div class="col-xl-9 col-lg-9 col-md-6 col-dm-6 col-6">
                                    <div class="view__main__text__left">
                                          <p><?= $oneks['mota'] ?></p>
                                    </div>
                              </div>
                              <div class="col-xl-3 col-lg-3 col-md-6 col-dm-6 col-6">
            ...
            <div class="view__room">
                  ...
                  <div class="view__service">
                        ...
                        <div class="view__service__content">
                              <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-dm-6 col-12">
