                    ...
                    <div class="body">
                        <div class="infor__form active" id="dm-1">
                            ...
                            <div class="infor__avatar">
                                <img class="img-fluid" src="./img/user/<?=$user['anh']?>" alt="">
                            </div>
                            <div class="infor__input">
                                <form action="">
                                    <label for="">Họ tên :</label>
                                    <input type="text" disabled placeholder="<?=$user['hoten']?>">
                                    <label for="">Số điện thoại :</label>
                                    <input type="text" disabled placeholder="<?=$user['sdt']?>">
                                    <label for="">Email :</label>
                                    <input type="text" disabled placeholder="<?=$user['email']?>">
                                    <label for="">Địa chỉ:</label>
                                    <input type="text" disabled placeholder="<?=$user['diachi']?>">
