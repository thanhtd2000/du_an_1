                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <ul>
                            <li><a href=""><i class="fa-solid fa-location-dot"></i>Đảo Hòn Tre,
                                    Phường Vĩnh Nguyên,
                                    Thành phố Nha Trang,
                                    Tỉnh Khánh Hòa, Việt Nam</a></li>
                            <li><a href="" style="color: #f39f2d;"><i class="fa-solid fa-envelope"></i>VietnamExplorationTrips@gmail.com</a>
                            </li>
                            <li><a href="" style="color: #f39f2d; font-weight: 700;"><i class="fa-solid fa-phone"></i>1900 23 23 89 (Nhánh số 3)</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-3">
                        ...
                        <ul>
                            ...
                            <li><a href="">Chính sách giỏi quyết tranh chấp</a></li>
            ...
            <div class="footer__bottom">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <p>Khách sạn, biệt thự hoặc căn hộ kinh doanh dịch vụ lưu trú ngắn ngày; khu du lịch sinh thái
                        </p>
