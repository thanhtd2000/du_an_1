            ...
            <div class="addProducts_form">
                  <table class="table">
                        <thead class="thead-dark">
                              <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Mã khu du lịch</th>
                        ...
                        <tbody>
                              <?php
                              foreach ($listkhudulich as $dulich) {
                                    extract($dulich);
                  ...
                  <a href="index.php?act=addkdl"><button type="button" class="btn btn-info">Nhập thêm</button></a>
