                ...
                <div class="addProducts_form">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên khu du lịch</label>
                            <input type="text" class="form-control" placeholder="Nhập tên khu vực" name="tenkdl"
                               >
                    ...
                    <?= isset($error['makv']) ? $error['makv'] : '' ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="exampleInputEmail1" name="anh"
